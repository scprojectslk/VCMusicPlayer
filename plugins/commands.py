...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton("🔥 DEV 🔥", url='https://t.me/SCProjectsLK'),
    ],
    [
        InlineKeyboardButton('👥 Group', url='https://t.me/SCProjectsLK_Chat'),
...
async def show_help(client, message):
    buttons = [
        [
            InlineKeyboardButton("🔥 Source Code 🔥", url='https://github.com/notopensource.py'),
        ],
        [
            InlineKeyboardButton('👥 Group', url='https://t.me/SCProjectsLK_Chat'),
            InlineKeyboardButton('Channel 📢', url='https://t.me/SCProjectsLK'),
        ...
        [
            InlineKeyboardButton('🔰 Version 3.0 🔰', url='https://t.me/SCProjectsLK'),
